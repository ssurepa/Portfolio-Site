...
def add_to_dict(dictionary="", key="", definition=""):
  ...
  elif key == "" or definition == "":
    print("You need to send a word and a definition")
  else:
    print(f"{key} has been added")
    my_english_dict[key] = definition
...
def update_word(dictionary="", key="", definition=""):
  if type(dictionary) is not dict:
    print(f"You need to send a dictionary. You sent: {type(dictionary)}")
  elif key == "" or definition == "":
    ...
    my_english_dict[key] = definition
    print(f"{key} has been updated to: {definition}")
